...
public class slaveServerTwo {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            System.out.println("Esperando la solicitud del nodo en servidor 2 ");
            ...
            System.out.println(" Mensaje recibido en el server 2: " + message);
        ...
        System.out.println("Apagando servidor 2...");
